...
Unregister-ScheduledTask -TaskName "DrHoje_Dashboard_CEO_Workflow" -Confirm:$false -ErrorAction SilentlyContinue
...
Register-ScheduledTask -TaskName "Atualizar_Dashboard_CEO_Semana" -Action $action1 -Trigger $trigger1 -Settings $settings -Force
...
Register-ScheduledTask -TaskName "Atualizar_Dashboard_CEO_FimDeSemana" -Action $action2 -Trigger $trigger2 -Settings $settings -Force

Write-Host "CEO - DE SEGUNDA A SEXTA: A cada 45 minutos (07:00 as 22:00) - REGISTRADO COM TIMEOUT DE 15 MIN!"
Write-Host "CEO - FINAIS DE SEMANA: A cada 4 horas (08:00 as 22:00) - REGISTRADO COM TIMEOUT DE 15 MIN!"
